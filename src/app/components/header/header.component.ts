...
export class HeaderComponent implements OnInit {
  ngOnInit() {
    const toggleButton = document.querySelector('.icons__sidebar') as HTMLButtonElement;
    ...
    const ButtonProfile = document.querySelector('.icons__profile') as HTMLButtonElement;
